                            ...
                            <div className="post-comments">
                                ...
                                <div className="single-comment">
                                    <div className="comment-img">
                                        <img src={require("../../images/team-image/1.jpg")} alt="client" />
                                    </div>
                                ...
                                <div className="single-comment left-m">
                                    <div className="comment-img">
                                        <img src={require("../../images/team-image/2.jpg")} alt="client" />
                                    </div>
                                    <div className="comment-content">
                                        <h4>Doe John</h4>
                                        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Et minus, saepe porro a voluptatem, quidem aut libero consequatur unde molestiae quae impedit accusantium dolor est corporis! Dolores ut dignissimos doloribus?</p>
                                ...
                                <div className="single-comment">
                                    <div className="comment-img">
                                        <img src={require("../../images/team-image/3.jpg")} alt="client" />
                                    </div>
                                    <div className="comment-content">
                                        <h4>Steven Doe</h4>
                                        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Et minus, saepe porro a voluptatem, quidem aut libero consequatur unde molestiae quae impedit accusantium dolor est corporis! Dolores ut dignissimos doloribus?</p>
                                ...
                                <div className="single-comment">
                                    <div className="comment-img">
                                        <img src={require("../../images/team-image/5.jpg")} alt="client" />
                                    </div>
                                    <div className="comment-content">
                                        <h4>John Cina</h4>
                                        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Et minus, saepe porro a voluptatem, quidem aut libero consequatur unde molestiae quae impedit accusantium dolor est corporis! Dolores ut dignissimos doloribus?</p>
