...
const images = [
    require('../../images/works-image/2.jpg'),
    require('../../images/works-image/4.jpg')
]
                    ...
                    <div className="row">
                        <div className="col-lg-6 col-md-6">
                            <div className="project-details-image">
                                <img src={require("../../images/works-image/1.jpg")} alt="work" />
                        ...
                        <div className="col-lg-6 col-md-6">
                            <div className="project-details-image">
                                <img src={require("../../images/works-image/2.jpg")} alt="work" />
                        ...
                        <div className="col-lg-6 col-md-6">
                            <div className="project-details-image">
                                <img src={require("../../images/works-image/4.jpg")} alt="work" />
                        ...
                        <div className="col-lg-6 col-md-6">
                            <div className="project-details-image">
                                <img src={require("../../images/works-image/3.jpg")} alt="work" />
